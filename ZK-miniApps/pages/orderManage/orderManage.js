...
Page({
  ...
  switchTab: function(e) {
    ...
    wx.request({
      url: 'https://localhost:8083/getOrderBySellerStatus?seller=' + app.globalData.userName + '&status=' + e.detail.current,
      success:function(res){
    ...
    if (e.detail.current == 0) {
      console.log(0)
      wx.request({
        url: 'https://localhost:8083/getOrderBySeller?seller=' + app.globalData.userName,
        success:function(res){
  ...
  onShow: function () {
    ...
    if(user_id!=0){
      wx.request({
        url: 'https://localhost:8083/getOrderBySeller?seller=' + userName,
        success:function(res){
